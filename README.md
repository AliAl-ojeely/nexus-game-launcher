...
## What's New in `v2.5.0` – The "Insight & Control" Update

Version `2.5.0` introduces a complete **Game Statistics Dashboard**, library sorting, personal notes, folder details, and many UI/UX improvements.
