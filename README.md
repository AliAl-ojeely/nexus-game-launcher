...
[![Version](https://img.shields.io/badge/Version-1.9.3-red?style=for-the-badge)](https://github.com/AliAl-ojeely)
...
## What's New in `v1.9.3` – The "Total Control" Update

Version `1.9.3` introduces powerful manual controls, a complete visual overhaul of the edit modal, and a fully modular, maintainable codebase.
