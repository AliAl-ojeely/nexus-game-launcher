...
## What's New in `v2.1.0` – The "Total Control" Update

Version `2.1.0` introduces powerful manual controls, a complete visual overhaul of the edit modal, and a fully modular, maintainable codebase.
