...
[![Version](https://img.shields.io/badge/Version-2.5.6-red?style=for-the-badge)](https://github.com/AliAl-ojeely)
...
## What's New in `v2.5.6` – The "Insight & Control" Update

Version `2.5.6` introduces a complete **Game Statistics Dashboard**, library sorting, personal notes, folder details, and many UI/UX improvements.
