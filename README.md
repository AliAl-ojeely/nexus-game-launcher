...
[![Version](https://img.shields.io/badge/Version-2.2.5-red?style=for-the-badge)](https://github.com/AliAl-ojeely)
...
## What's New in `v2.2.5` – The "Total Control" Update

Version `2.2.5` introduces powerful manual controls, a complete visual overhaul of the edit modal, and a fully modular, maintainable codebase.
