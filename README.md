...
## What's New in `v2.2.0` – The "Total Control" Update

Version `2.2.0` introduces powerful manual controls, a complete visual overhaul of the edit modal, and a fully modular, maintainable codebase.
